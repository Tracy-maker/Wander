    ...
    >
      <div className="relative bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-3xl shadow-2xl p-8 sm:w-96 border border-white border-opacity-30">
        ...
        <div className="mt-6 text-center">
          <Link
            to="/Login"
            className="w-full inline-block bg-blue-500 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-600 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-400 animate-bounce"
          >
            Log in
          </Link>
        </div>
