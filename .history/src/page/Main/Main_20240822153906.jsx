  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto pt-16 px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="text-2xl sm:text-3xl lg:text-4xl text-white text-center font-light tracking-wider">
          <Typewriter
            options={{
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto flex items-start space-x-8">
