      ...
      >
        ...
        <div className="relative z-10 max-w-screen-lg text-center px-8 py-16">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-white font-light mb-8 leading-relaxed tracking-wide">
            ☀️ WanderWhiz is your ultimate travel companion, designed to provide you with the latest weather updates, explore international time zones, and navigate through maps with ease. Whether you're planning your next adventure or just curious about the world around you, WanderWhiz is here to make your journey brighter.

Our app combines sophisticated technology with a user-friendly interface to bring you the most accurate and up-to-date information. Explore the world with WanderWhiz, your trusted guide in every journey. ☃️
          </p>
