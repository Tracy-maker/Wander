...
const Weather = () => {
  ...
  return (
    <div
      className="min-h-screen w-screen flex flex-col justify-center items-center bg-cover bg-center relative p-4 overflow-y-auto"  // Ensure scrollability
      style={{ backgroundImage: `url(${p1})`, paddingTop: "80px" }}
    >
      <div className="flex flex-col md:flex-row w-full max-w-6xl items-center justify-between space-y-6 md:space-y-0 md:space-x-8">
        ...
        <div className="w-full md:w-2/3 bg-white bg-opacity-90 rounded-2xl shadow-xl p-6 text-gray-800">
          {currentWeather ? (
