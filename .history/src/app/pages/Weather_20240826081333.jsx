...
const Weather = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto pt-2 mt-[-3rem] px-4 sm:px-6 lg:px-8 flex items-center justify-between">
      <div className="relative z-10 w-full max-w-6xl mx-auto mt-[-5rem] px-4 sm:px-6 lg:px-8 flex items-center justify-between">
