...
const Weather = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url(${p1})`, paddingTop: "160px" }} // Further increased padding
    >
      <div className="flex flex-col md:flex-row w-full max-w-6xl items-center justify-between space-y-6 md:space-y-0 md:space-x-8 sm:mt-16">  {/* Added more margin-top for small screens */}
