  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row w-full max-w-6xl items-center justify-between space-y-6 md:space-y-0 md:space-x-8">
        ...
        <div className="w-full md:w-2/3 bg-white bg-opacity-90 rounded-2xl shadow-xl p-6 text-gray-800"> {/* Full width on mobile, 2/3 on desktop */}
          {currentWeather ? (
      ...
      <div className="w-full max-w-6xl mt-8"> {/* Stacked on mobile, regular on desktop */}
