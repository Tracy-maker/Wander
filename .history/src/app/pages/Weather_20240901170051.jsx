...
const Weather = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url(${p1})`, paddingTop: "120px" }} // Adjusted padding for all screens
    >
      <div className="flex flex-col md:flex-row w-full max-w-6xl items-center justify-between space-y-6 md:space-y-0 md:space-x-8 sm:mt-12">  {/* Added margin-top for small screens */}
