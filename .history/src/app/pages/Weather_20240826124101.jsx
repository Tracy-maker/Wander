...
const Weather = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto flex items-start space-x-8 mt-12"> {/* Adjusted top margin */}
        <div className="w-2/3 bg-white bg-opacity-90 rounded-2xl shadow-xl p-6 text-gray-800"> {/* Reduced padding */}
          {currentWeather && (
        ...
        <div className="w-1/3 flex flex-col space-y-6"> {/* Reduced spacing between components */}
          <div className="bg-white bg-opacity-90 rounded-2xl shadow-xl p-6 text-gray-800"> {/* Reduced padding */}
