  ...
  return (
    <div className="p-4 w-1/3 fixed">
      <div className="flex justify-between items-center mb-2">
        <h4 className="text-sm font-semibold">Food & Dining around you</h4> {/* Smaller heading */}
        <div className="flex flex-col items-end">
          <div className="mb-4">
            ...
            <select
              ...
              className="mt-1 block pl-3 pr-1 py-1 text-sm border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-xs rounded-md"
            >
