      ...
      <div className="flex-grow overflow-y-auto p-4">
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="overflow-auto h-96">
              {places?.map((place, i) => (
                <div 
                  ...
                  onClick={() => handlePlaceClick(place)} // Handle click
                >
                  <div className={`p-2 ${selectedPlace === place ? 'bg-blue-200' : 'bg-white'} rounded-md`}>
            ...
            {/* Display selected place details as a card below the list */}
            {selectedPlace && (
