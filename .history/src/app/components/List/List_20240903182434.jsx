        ...
        <>
          ...
          <div className="mb-4">
            ...
            <select
              ...
              className="mt-1 block w-full pl-2 pr-10 py-2 text-sm border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-xs rounded-md"
            >
