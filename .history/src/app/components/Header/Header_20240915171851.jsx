...
// Google Maps libraries needed for places and autocomplete
const libraries = ["places"];

const Header = ({ onPlaceChanged, onLoad }) => {
  return (
    <LoadScript
      googleMapsApiKey={process.env.REACT_APP_GOOGLE_MAPS_API_KEY} // Make sure your API key is correct
      libraries={libraries} // Provide the required libraries
    >
