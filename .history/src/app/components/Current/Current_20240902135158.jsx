...
const Current = ({ data }) => {
  ...
  return (
    <div className="flex flex-col md:flex-col lg:flex-row py-6 px-4 md:px-8 bg-gradient-to-r from-blue-500 to-blue-400 text-white rounded-lg shadow-lg">
      ...
      <div className="lg:w-1/3 flex items-center justify-center lg:justify-end text-4xl md:text-5xl lg:text-6xl font-semibold text-center mt-6 lg:mt-0">
        {data.city}
      </div>
    </div>
  );
