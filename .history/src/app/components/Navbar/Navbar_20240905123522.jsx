...
import { FaMapMarkerAlt, FaPhone, FaStar, FaStarHalfAlt, FaRegStar } from 'react-icons/fa'; // Importing icons from react-icons
  ...
  return (
    <div className="shadow-lg rounded-lg overflow-hidden">
      <div 
        ...
        style={{ backgroundImage: `url(${place?.photo?.images?.large?.url || 'https://www.foodserviceandhospitality.com/wp-content/uploads/2016/09/Restaurant-Placeholder-001.jpg'})` }}
        title={place?.name}
      />
      <div className="p-4">
